# nvim-treesitter-queries-perl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-perl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-perl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **perl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-perl",
...
- [ ] Changes are scoped to `perl` — do not include files for other languages
